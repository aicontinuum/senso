...
// The limits a customer may set are checked by the rules both sites share.
export { THRESHOLD_MIN_C, THRESHOLD_MAX_C, validateThresholds } from '@senso/thresholds';
